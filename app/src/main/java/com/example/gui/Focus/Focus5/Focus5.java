...
public class Focus5 extends AppCompatActivity implements View.OnClickListener, CardView {
    ...
    private void choseUnit(View v){
        ...
        switch (v.getId()) {
            ...
            case R.id.Unit1:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit1.class);
                startActivity(i);
                break;
            case R.id.Unit2:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit2.class);
                startActivity(i);
                break;
            case R.id.Unit3:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit3.class);
                startActivity(i);
                break;
            case R.id.Unit4:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit4.class);
                startActivity(i);
                break;
            case R.id.Unit5:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit5.class);
                startActivity(i);
                break;
            case R.id.Unit6:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit6.class);
                startActivity(i);
                break;
            case R.id.Unit7:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit7.class);
                startActivity(i);
                break;
            case R.id.Unit8:
                i = new Intent(Focus5.this, com.example.gui.Focus.Focus5.Units.Unit8.class);
                startActivity(i);
                break;
        }
    }
