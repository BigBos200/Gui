...
import com.example.gui.Units.Unit1;
import com.example.gui.Units.Unit2;
import com.example.gui.Units.Unit3;
import com.example.gui.Units.Unit4;
import com.example.gui.Units.Unit5;
import com.example.gui.Units.Unit6;
import com.example.gui.Units.Unit7;
import com.example.gui.Units.Unit8;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.Unit7:
                ...
                i = new Intent(Focus3.this, com.example.gui.Units.Unit7.class);
                startActivity(i);
                break;
            case R.id.Unit8:
                ReadFromFile<Efocus, Efocus> sfu8 = new ReadFromFile<>(Efocus.EFOCUS3, Efocus.EUNIT8);
                i = new Intent(Focus3.this, com.example.gui.Units.Unit8.class);
                startActivity(i);
                break;
        }
    }
